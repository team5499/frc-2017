...
void OperatorController::handle()
{
  ...
  hardware::drive_left1.Set(
          hardware::throttle.GetRawAxis(1) - hardware::wheel.GetRawAxis(0));
  hardware::drive_left2.Set(
          hardware::throttle.GetRawAxis(1) - hardware::wheel.GetRawAxis(0));
  hardware::drive_right1.Set(
          hardware::throttle.GetRawAxis(1) + hardware::wheel.GetRawAxis(0));
  hardware::drive_right2.Set(
          hardware::throttle.GetRawAxis(1) + hardware::wheel.GetRawAxis(0));
